...
const translations = {
  en: {
    ...
    qr: {
      welcomeBadge:     "Welcome to Kai's Coffee",
      welcomeBack:      "Welcome back",
      headline:         "Fresh drinks.\nReal rewards.",
      tagline:          "Scan. Sip. Earn.",
      earnFree:         "Earn a free drink",
      afterVisits:      "after just 8 visits",
      stampProgress:    "stamps collected",
      moreToGo:        "more to go!",
      viewMenu:         "View Menu",
      joinRewards:      "Join Rewards",
      signIn:           "Sign In",
  ...
  es: {
    ...
    qr: {
      welcomeBadge:     "Bienvenido a Kai's Coffee",
      welcomeBack:      "Bienvenido de nuevo",
      headline:         "Bebidas frescas.\nRecompensas reales.",
      tagline:          "Escanea. Saborea. Gana.",
      earnFree:         "Gana una bebida gratis",
      afterVisits:      "después de solo 8 visitas",
      stampProgress:    "sellos acumulados",
      moreToGo:        "¡más para completar!",
      viewMenu:         "Ver Menú",
      joinRewards:      "Unirse a Recompensas",
      signIn:           "Iniciar Sesión",
      myRewards:        "Mis Recompensas",
      installHint:      "Añade a tu pantalla de inicio para acceso rápido",
    },
    langPicker: {
