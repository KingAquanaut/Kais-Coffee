...
const translations = {
  en: {
    ...
    about: {
      ...
      scheduleTitle:      "Schedule & pop-ups",
      scheduleEmptyTitle: "Schedule coming soon",
      scheduleEmptyBody:  "Upcoming pop-ups, private events and seasonal hours will appear here.",
      joinRewards:      "Join Rewards",
  ...
  es: {
    ...
    about: {
      ...
      scheduleTitle:      "Calendario y pop-ups",
      scheduleEmptyTitle: "Calendario próximamente",
      scheduleEmptyBody:  "Aquí aparecerán los próximos pop-ups, eventos privados y horarios de temporada.",
      joinRewards:      "Unirse a Recompensas",
